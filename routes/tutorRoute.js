...
router.get('/displayQuestions/:questionId', jwtMiddleWare, handleDisplayQuestion)
...
router.patch('/showInformation/:infoId', jwtMiddleWare, handleShowInformation)
...
router.patch('/showResults/:assesmentId', jwtMiddleWare, handleShowResults)
